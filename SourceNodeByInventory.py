...
cache.set('dictionary_sku_store' , "")
list_zip_codes = []
dictionary_states_zip = {}
dictionary_store_zip = {}
list_target_zip_codes = []
path_to_file = 'D:/Order Optimizer/Order Data/Order Optimizer/US_1day_data.csv'
path_to_store_details = 'D:/Order Optimizer/StoreData_US.xlsx'
capacitythreshhold = 2
naveda = [5, 8, 9]
texas = [3, 6, 7]
georgia = [2, 3, 4]
new_jersey = [0, 1]
...
def get_sku_store_from_solr():
    ...
    cache.set("dictionary_sku_store", dictionary_sku_store)
